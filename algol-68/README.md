...
Code examples for Algol-68 programming language from [CodeArchaeology.dev](https://codearchaeology.dev/languages/algol-68/).
...
- [Functions in ALGOL 68](05-functions/) - Learn how to define and call procedures in ALGOL 68 - parameters, return values, recursion, scope, and higher-order procedures with Docker-ready examples
